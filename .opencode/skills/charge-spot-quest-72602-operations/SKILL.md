...
single-replica thin FastAPI booking API with in-cluster SQLite. Delegate live
...
4. Test `https://charge.72602.space/health` and `https://charge.72602.space/readyz` with strict TLS.
